import glob             #search for specific file name or pattern
import os               #function to interact with os for file managemnet
import pandas as pd     #library for analizing big data and make conclusion based on statistical theories.
import numpy as np
import shutil           #method to copy the content from source to destination
import librosa          #it is used for music and audio analysis
from tqdm import tqdm   #it helps in visualizing the completion of loop
